...
namespace Updater
{
    public class AppRunner
    {
        ...
        public static bool CreateProcessInConsoleSession(string appName, String CommandLine, bool bElevate)
        {
            ...
            if (bElevate)
            {
                        ...
                        IntPtr.Zero, IntPtr.Zero))
                {
                    ...
                    {
                        Debug.Print(String.Format("CreateProcessInConsoleSession AdjustTokenPrivileges error: {0}",
                            nErr));
                    }
                }
            }
